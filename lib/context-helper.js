...
pub.getParallelGatewaysInPath = function(context, sequenceFlowId) {
  ...
  outbound.forEach((flow) => {
    parallelGateways = parallelGateways.concat(pub.getParallelGatewaysInPath(context, flow.element.id));
  });
