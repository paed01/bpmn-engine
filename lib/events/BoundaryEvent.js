...
BoundaryEvent.prototype.activate = function(state) {
  ...
  function AttachedListener(attachedApi, attachedExecution) {
    const boundEventExecution = ActivityExecution(activityApi, null, environment);
    ...
    function attach() {
      ...
      // attachedTo.on('end', onAttachedLeave);
    ...
    function unattach() {
      ...
      // attachedTo.removeListener('end', onAttachedLeave);
