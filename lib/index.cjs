...
/**
 * @typedef {import('types').BpmnEngineOptions} BpmnEngineOptions
 * @typedef {import('types').BpmnEngineExecuteOptions} BpmnEngineExecuteOptions
 * @typedef {import('types').BpmnEngineExecutionState} BpmnEngineExecutionState
 * @typedef {import('types').BpmnEngineEvent} BpmnEngineEvent
 * @typedef {import('types').BpmnEngineRunningStatus} BpmnEngineRunningStatus
 * @typedef {import('types').BpmnMessage} BpmnMessage
 * @typedef {import('types').SerializableContext} SerializableContext
 */
 ...
 * @param {BpmnEngineExecuteOptions | ((err: Error, execution?: Execution) => void)} [optionsOrCallback]
 ...
 * @param {BpmnEngineExecutionState | null} savedState
 * @param {BpmnEngineOptions} [recoverOptions]
 * @returns {Engine}
 */
 ...
 * @param {{ sourceContext: SerializableContext }} [options]
 */
...
/**
 * @param {BpmnEngineExecuteOptions} [executeOptions]
 * @returns {Promise<any[]>}
 */
...
/** @returns {Promise<BpmnEngineExecutionState>} */
...
/**
 * @template R
 * @param {BpmnEngineEvent} eventName
 * @returns {Promise<R>}
 */
 ...
 * @param {BpmnEngineExecuteOptions} [options]
