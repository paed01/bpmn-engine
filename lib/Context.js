...
internals.Context.prototype.getVariablesAndServices = function() {
  return {
...
function getService(serviceDef) {
  let module;
  if (!serviceDef.type || serviceDef.type === 'require') {
    module = require(serviceDef.module);
  } else if (serviceDef.type === 'global' && serviceDef.module === 'require') {
    module = require;
  }
