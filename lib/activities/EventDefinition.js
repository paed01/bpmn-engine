...
function EventDefinition(activity) {
  ...
  this.cancelActivity = eventDefinition.cancelActivity;
}

EventDefinition.prototype = Object.create(Activity.prototype);

EventDefinition.prototype.run = function(message) {
...
EventDefinition.prototype.execute = function(executionContext, callback) {
