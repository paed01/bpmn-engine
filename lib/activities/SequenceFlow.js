...
module.exports = internals.SequenceFlow = function(activity) {
...
internals.SequenceFlow.prototype = Object.create(Flow.prototype);

internals.SequenceFlow.prototype.take = function() {
  let taken = true;
  if (this.condition) {
...
internals.SequenceFlow.prototype.executeCondition = function(context) {
