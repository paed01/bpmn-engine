...
internals.Flow.prototype.take = function() {
  ...
  if (this.condition) {
    ...
    executionContext.variables = Object.freeze(Object.assign({}, executionContext.variables));
    executionContext.services = Object.freeze(Object.assign({}, executionContext.services));
