...
Form.prototype.init = function(message, contextVariables) {
  if (this.formData.formKey) {
    this.key = getFormKey.call(this, message, contextVariables);
  }

  if (!this.formData.fields) return;
  this.fields = initFields.call(this, message, contextVariables);
};
