...
module.exports = function ActivityExecution(parentApi, message, environment) {
  ...
  const activityFormKey = parentApi.formKey;
  ...
  function getInput(override) {
    ...
    inputResult = inputResult || activeIo.getInput();
    if (override) {
  ...
  function getIteration(loopMessage) {
    ...
    const loopExecution = ActivityExecution(parentApi, loopMessage);
