...
module.exports = function execution(activity, message, environment, inboundFlow, rootFlow) {
  ...
  function getInput() {
    ...
    inputResult = (io && io.getInput(message, environment.getVariablesAndServices())) || environment.getVariablesAndServices();
  ...
  function getIteration(loopMessage) {
    ...
    const loopExecution = execution(activity, loopMessage, iterationEnvironment, inboundFlow, rootFlow);
  ...
  function getOutput() {
    ...
    return (io && io.getOutput(resultData, environment.getVariablesAndServices()));
