...
internals.Connector.prototype.execute = function(executeOnBehalfOf, message, callback) {
  const scope = this;
  ...
  function serviceCallback() {
    ...
    debug(`<${scope.name}>`, 'completed with', err, output);
...
internals.Connector.prototype.getOutput = function(result) {
